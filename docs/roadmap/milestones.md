...
This slice adds no public schema APIs, field profiling, second adapter, semantic mappings, embeddings, AI behavior, Manual Class Manager, class query UI, duplicate grouping, auto class recommendations, or review UI. R2 remains in progress and is not production readiness.
### Required tests
