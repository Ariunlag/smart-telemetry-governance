...
| D-007 | Define R1 stream-catalog entry decisions before coding | Accepted and implemented | [ADR-003](../decisions/ADR-003-r1-stream-catalog-entry-decisions.md) selects PostgreSQL as catalog authority and defines retention, MQTT authorization, stream identity/idempotency, and malformed/redelivery constraints. Initial R1 catalog and ADR-004 delivery work are implemented; broader R1 remains in progress. |
