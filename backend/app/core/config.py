...
class Settings(BaseSettings):
    ...
    raw_observation_retention_days: int = Field(default=30, ge=1, le=365)
    ...
    schema_observation_worker_batch_size: int = Field(default=10, ge=1, le=500)
    schema_observation_worker_lease_seconds: int = Field(default=30, ge=1, le=3600)
